...
@ActiveProfiles("mode-a")
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class ModeAOpaqueIntrospectionTest {
    ...
    @Test
    void opaqueTokensTriggerIntrospectionOnEachRequest() {
        ...
        assertThat(snapshot.opaqueIntrospections()).isEqualTo(5);
        assertThat(snapshot.jwtDecodes()).isZero();
    }
}
